...
const productAPI = `${baseUrl}/api/sl-services?filters[category][id][$in][0]=8&[rating][$eq]=3&[rating][$eq]=4&[rating][$eq]=5&[rating][$eq]=1&[rating][$eq]=2&pagination%5BpageSize%5D=12&populate=%2A&[price][$between]=0-50,51-100,101-999`;
