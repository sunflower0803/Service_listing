...
// const productAPI = `${baseUrl}/api/sl-services?filters[category][name][$containsi]=Res&[category][id][$in][0]=9&[rating][$eq]=3&[rating][$eq]=4&[rating][$eq]=5&[rating][$eq]=1&[rating][$eq]=2&pagination%5BpageSize%5D=12&populate=%2A`;
      ...
      try {
        ...
        cardContainer.innerHTML += `
          ...
          <div
                      ...
                      <a href="../detailpage.html?id=${item.id}" onclick="">
                          <img src=${imageUrl}
